...
CREATE TABLE IF NOT EXISTS `banner_groups_backup_20250705_194820` AS SELECT * FROM `banner_groups`;

CREATE TABLE IF NOT EXISTS `banner_layouts_backup_20250705_194820` AS SELECT * FROM `banner_layouts`;

CREATE TABLE IF NOT EXISTS `banner_styles_backup_20250705_194820` AS SELECT * FROM `banner_styles`;
