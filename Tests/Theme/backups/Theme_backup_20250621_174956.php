            ...
            <div class="container-fluid">
                ...
                <form id="themeForm">
                    ...
                    <div class="tab-content" id="themeTabContent">
                        ...
                        <div class="tab-pane fade in active" id="general-panel" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="theme-preview">
                                                <p class="text-muted">Banner önizlemesi yakında eklenecektir.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>                        <!-- Form & Butonlar Sekmesi -->
                        <?php include __DIR__ . '/Theme/tabs/forms.php'; ?>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card">
                                ...
                                <div class="col-lg-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="theme-preview">
                                                <p class="text-muted">Form önizlemesi yakında eklenecektir.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>                        <!-- Responsive Sekmesi -->
                        <?php include __DIR__ . '/Theme/tabs/responsive.php'; ?>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card">
