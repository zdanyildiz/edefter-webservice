...
if(!empty($_FILES))
{
    ...
    hatalogisle("fiyat listesi yükle","$gecicidosya - $dosyaad - $size - $uzanti - $yenidosyatamad - $hedef");
    ...
    {
        hatalogisle("fiyat listesi yükle","dosya yüklenemedi");
    }
}
else
{
    hatalogisle("fiyat listesi yükle","dosya yok");
}
?>
