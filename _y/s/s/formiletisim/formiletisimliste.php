...
$formhata=0;
$formhataaciklama="";
$formtablo="formiletisim";

//düzenle
$sayfabaslik="Form İletişim Listesi";
$formbaslik="Form İletişim Listesi";

Veri(true);
$formiletisim_d=0;
$formiletisim_s="SELECT adsoyad,telefon,eposta,formsil,mesaj,tarih,formid FROM formiletisim WHERE formsil='0' and formcevapid='0' ORDER BY formid DESC";
$formiletisim_v=$data->query($formiletisim_s);
if($formiletisim_v->num_rows>0)$formiletisim_d=1;
unset($formiletisim_s);
?>
<!DOCTYPE html>
<html lang="tr">
	<head>
	...
	<body class="menubar-hoverable header-fixed ">
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">Form İletişim Listesi</li>
						</ol>
					</div>			
								...
								<div class="card">
									<div class="card-body ">
										<table class="table no-margin">
											...
											if($formiletisim_d==1)
											{
												while ($formiletisim_t=$formiletisim_v->fetch_assoc()) 
												{
													$formid=$formiletisim_t["formid"];
													$adsoyad=$formiletisim_t["adsoyad"];
													$telefon=$formiletisim_t["telefon"];	
													$eposta=$formiletisim_t["eposta"];
													$mesaj=$formiletisim_t["mesaj"];
													$cevapid=teksatir("SELECT formcevapid from formiletisim Where formcevapid='".$formid."'","formcevapid")
												?>
												<tr id="tr<?=$formid?>">
													<td><?=$formid?></td>
													<td><?=$adsoyad?></td>
													...
													<td>
                                                        <a
                                                            href="/_y/s/s/formiletisim/formiletisim.php?mesajid=<?=$formid?>"
											...
											unset($formiletisim_d,$formiletisim_v,$formid,$adsoyad);
											?>
											</tbody>
										</table>
									</div><!--end .card-body -->
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="simpleModalLabel">Form İletişim Bilgisini Sil</h4>
					</div>
					<div class="modal-body">
						<p>Form İletişim Bilgisini silmek istediğinize emin misiniz?</p>
					</div>
		...
		<script>
			...
			{
				$('a#formsil').click(function ()
				{
					$silid=$(this).data("id");
				});
				$('#silbutton').click(function ()
				{
					$('#_islem').attr('src', "/_y/s/f/sil.php?sil=formiletisim&id="+$silid);
				});
			 });
		</script>
		<script>
			$("#formiletisimlistephp").addClass("active");
		</script>
	</body>
</html>
