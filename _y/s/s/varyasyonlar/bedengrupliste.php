...
//düzenle
$sayfabaslik="Ürun Beden Grup";
$formbaslik="Ürun Beden Grup Liste";

Veri(true);
$urunbedengrup_d=0;
$urunbedengrup_s="SELECT urunbedengrupid,urunbedengrupad FROM urunbedengrup WHERE urunbedengrupsil='0' ORDER BY urunbedengrupid ASC";
...
<html lang="tr">
	...
	<body class="menubar-hoverable header-fixed ">
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">Ürun Beden Gruplar</li>
							<li class="active"><a href="/_y/s/s/varyasyonlar/bedengrupekle.php" class="btn ink-reaction btn-raised btn-primary"><?=$sayfabaslik?> Ekle (+)</a></li>
						</ol>
					</div>			
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-head style-primary">
										...
										<div class="tools">
											<a class="btn btn-floating-action btn-default-light" href="/_y/s/s/varyasyonlar/bedengrupekle.php"><i class="fa fa-plus"></i></a>
										</div>
									</div>
								</div><!--end .card -->
							</div><!--end .col -->
									...
									<div class="card-body ">
										<table class="table no-margin">
											...
											if($urunbedengrup_d==1)
											{
												...
												{
													$urunbedengrupid=$urunbedengrup_t["urunbedengrupid"];
													$urunbedengrupad=$urunbedengrup_t["urunbedengrupad"];
												?>
												<tr id="tr<?=$urunbedengrupid?>">
													<td><?=$urunbedengrupid?></td>
													<td><?=$urunbedengrupad?></td>
													<td>
														<a 
															href="/_y/s/s/varyasyonlar/bedengrupekle.php?urunbedengrupid=<?=$urunbedengrupid?>" 
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="simpleModalLabel">Beden Grup Sil</h4>
					</div>
		...
		<script>
			...
			{
				$('a#bedengrupsil').click(function ()
				{
					$silid=$(this).data("id");
				});
				$('#silbutton').click(function ()
				{
					$('#_islem').attr('src', "/_y/s/f/sil.php?sil=bedengrup&id="+$silid);
				});
			 });
		</script>
		<script>
			$("#bedengruplistephp").addClass("active");
		</script>
	</body>
</html>
