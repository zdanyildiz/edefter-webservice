...
$formhata=0;
$formhataaciklama="";
$formtablo="varyantgrup";

//düzenle
$sayfabaslik="Varyant Grup";
$formbaslik="Varyant Grup Liste";


$varyantgrup_d=0;
$varyantgrup_s="SELECT varyantgrupid,varyantgrupad FROM urunvaryantgrup WHERE varyantgrupsil='0' ORDER BY varyantgrupid ASC";
$varyantgrup_v=$db->select($varyantgrup_s);
if($varyantgrup_v)$varyantgrup_d=1;
unset($varyantgrup_s);
?>
<!DOCTYPE html>
<html lang="tr">
    ...
    <div id="content">
        <section>
            <div class="section-header">
                <ol class="breadcrumb">
                    <li>Ayarlar</li>
                    <li>Ürun Renk Gruplar</li>
                    <li><a href="/_y/s/s/varyasyonlar/varyant_grupekle.php"><?=$sayfabaslik?> Ekle (+)</a></li>
                </ol>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-head style-primary">
                                ...
                                <div class="tools">
                                    <a class="btn btn-floating-action btn-default-light" href="/_y/s/s/varyasyonlar/varyant_grupekle.php"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div><!--end .card -->
                    </div><!--end .col -->
                        ...
                        <div class="card">
                            <div class="card-body ">
                                <table class="table no-margin">
                                    ...
                                    if($varyantgrup_d==1)
                                    {
                                        foreach ($varyantgrup_v as $varyantgrup_t)
                                        {
                                            $varyantgrupid=$varyantgrup_t["varyantgrupid"];
                                            $varyantgrupad=$varyantgrup_t["varyantgrupad"];
                                            ?>
                                            <tr id="tr<?=$varyantgrupid?>">
                                                <td><?=$varyantgrupid?></td>
                                                <td>
                                                    <?=$varyantgrupad?>
                                                    <a
                                                            href="/_y/s/s/varyasyonlar/varyant_grupekle.php?varyantgrupid=<?=$varyantgrupid?>&variantNameEdit=1"
                                                ...
                                                <td>
                                                    <a
                                                            href="/_y/s/s/varyasyonlar/varyant_grupekle.php?varyantgrupid=<?=$varyantgrupid?>"
                                                            class="btn btn-icon-toggle"
                                                            data-toggle="tooltip"
                                                            data-placement="top"
                                                            data-original-title="Düzenle">
                                    ...
                                    unset($varyantgrup_d,$varyantgrup_v,$varyantgrupid,$varyantgrupkisaad);
                                    ?>
                                    </tbody>
                                </table>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="simpleModalLabel">Varyant Grup Sil</h4>
            </div>
            <div class="modal-body">
                <p>Grubu silmek istediğinize emin misiniz?</p>
                <p>Varyant Grubu ve tüm alt seçenekleri silinecektir!</p>
            </div>
...
<script>
    ...
    {
        $('a#varyantgrupsil').click(function ()
        {
            $silid=$(this).data("id");
        });
        $('#silbutton').click(function ()
        {
            $.ajax({
                type: 'GET',
                url:"/_y/s/f/sil.php?sil=varyantgrup&id="+$silid,
                dataType: "html",
...
<script>
    $("#varyantgruplistephp").addClass("active");
</script>
</body>
</html>
