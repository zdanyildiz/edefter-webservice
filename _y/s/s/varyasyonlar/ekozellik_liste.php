...
//düzenle
$sayfabaslik="Ek Özellik";
$formbaslik="Ek Özellik Liste";

$ekozellik_d=0;
$ekozellik_s="SELECT * FROM urunekozellikler WHERE ekozelliksil='0' ORDER BY ekozellikad ASC";
$ekozellik_v=$db->select($ekozellik_s);
if($ekozellik_v)$ekozellik_d=1;
unset($ekozellik_s);
?>
<!DOCTYPE html>
<html lang="tr">
        ...
        <section>
            <div class="section-header">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/_y/s/s/varyasyonlar/ekozellik_ekle.php"><?=$sayfabaslik?> Ekle (+)</a></li>
                </ol>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-head style-primary">
                                ...
                                <div class="tools">
                                    <a class="btn btn-floating-action btn-default-light" href="/_y/s/s/varyasyonlar/ekozellik_ekle.php"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div><!--end .card -->
                    </div><!--end .col -->
                        ...
                        <div class="card">
                            <div class="card-body ">
                                <table class="table no-margin">
                                    ...
                                    if($ekozellik_d==1)
                                    {
                                        foreach ($ekozellik_v as $ekozellik_t)
                                        {
                                            $ekozellikid=$ekozellik_t["ekozellikid"];
                                            $ekozellikad=$ekozellik_t["ekozellikad"];
                                            $ekozellikdeger=$ekozellik_t["ekozellikdeger"];
                                            ?>
                                            <tr id="tr<?=$ekozellikid?>">
                                                <td><?=$ekozellikid?></td>
                                                <td><?=$ekozellikad?></td>
                                                <td><?=$ekozellikdeger?></td>
                                                <td>
                                                    <a  id="ekozelliksil"
                                                        href="#textModal"
                                    ...
                                    unset($ekozellik_d,$ekozellik_v,$ekozellikid,$ekozellikkisaad);
                                    ?>
                                    </tbody>
                                </table>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="simpleModalLabel">Ek Özellik Sil</h4>
            </div>
            <div class="modal-body">
                <p>Ek Özelliği silmek istediğinize emin misiniz?</p>
            </div>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('#silbutton').click(function ()
        {
            $.ajax({
                type: 'GET',
                url:"/_y/s/f/sil.php?sil=ekozellik&id="+$silid,
                dataType: "html",
...
<script>
    $("#ekozelliklistephp").addClass("active");
</script>
</body>
</html>
