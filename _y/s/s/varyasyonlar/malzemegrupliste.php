...
//düzenle
$sayfabaslik="Ürun Malzeme Grup";
$formbaslik="Ürun Malzeme Grup Liste";

Veri(true);
$urunmalzemegrup_d=0;
$urunmalzemegrup_s="SELECT urunmalzemegrupid,urunmalzemegrupad FROM urunmalzemegrup WHERE urunmalzemegrupsil='0' ORDER BY urunmalzemegrupid ASC";
...
<html lang="tr">
	...
	<body class="menubar-hoverable header-fixed ">
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">Ürun Malzeme Gruplar</li>
							<li class="active"><a href="/_y/s/s/varyasyonlar/malzemegrupekle.php" class="btn ink-reaction btn-raised btn-primary"><?=$sayfabaslik?> Ekle (+)</a></li>
						</ol>
					</div>			
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-head style-primary">
										...
										<div class="tools">
											<a class="btn btn-floating-action btn-default-light" href="/_y/s/s/varyasyonlar/malzemegrupekle.php"><i class="fa fa-plus"></i></a>
										</div>
									</div>
								</div><!--end .card -->
							</div><!--end .col -->
									...
									<div class="card-body ">
										<table class="table no-margin">
											...
											if($urunmalzemegrup_d==1)
											{
												...
												{
													$urunmalzemegrupid=$urunmalzemegrup_t["urunmalzemegrupid"];
													$urunmalzemegrupad=$urunmalzemegrup_t["urunmalzemegrupad"];
												?>
												<tr id="tr<?=$urunmalzemegrupid?>">
													<td><?=$urunmalzemegrupid?></td>
													<td><?=$urunmalzemegrupad?></td>
													<td>
														<a 
															href="/_y/s/s/varyasyonlar/malzemegrupekle.php?urunmalzemegrupid=<?=$urunmalzemegrupid?>" 
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="simpleModalLabel">Malzeme Grup Sil</h4>
					</div>
		...
		<script>
			...
			{
				$('a#malzemegrupsil').click(function ()
				{
					$silid=$(this).data("id");
				});
				$('#silbutton').click(function ()
				{
					$('#_islem').attr('src', "/_y/s/f/sil.php?sil=malzemegrup&id="+$silid);
				});
			 });
		</script>
		<script>
			$("#malzemegruplistephp").addClass("active");
		</script>
	</body>
</html>
