...
//düzenle
$sayfabaslik="Ürun Renk Grup";
$formbaslik="Ürun Renk Grup Liste";

Veri(true);
$urunrenkgrup_d=0;
$urunrenkgrup_s="SELECT urunrenkgrupid,urunrenkgrupad FROM urunrenkgrup WHERE urunrenkgrupsil='0' ORDER BY urunrenkgrupid ASC";
$urunrenkgrup_v=$data->query($urunrenkgrup_s);
if($urunrenkgrup_v->num_rows>0)$urunrenkgrup_d=1;
unset($urunrenkgrup_s);
?>
<!DOCTYPE html>
<html lang="tr">
<head>
        ...
        <section>
            <div class="section-header">
                <ol class="breadcrumb">
                    ...
                    <li class="btn ink-reaction btn-raised btn-primary disabled">Ürun Renk Gruplar</li>
                    <li class="active"><a href="/_y/s/s/varyasyonlar/renkgrupekle.php" class="btn ink-reaction btn-raised btn-primary"><?=$sayfabaslik?> Ekle (+)</a></li>
                </ol>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-head style-primary">
                                ...
                                <div class="tools">
                                    <a class="btn btn-floating-action btn-default-light" href="/_y/s/s/varyasyonlar/renkgrupekle.php"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div><!--end .card -->
                    </div><!--end .col -->
                            ...
                            <div class="card-body ">
                                <table class="table no-margin">
                                    ...
                                    if($urunrenkgrup_d==1)
                                    {
                                        ...
                                        {
                                            $urunrenkgrupid=$urunrenkgrup_t["urunrenkgrupid"];
                                            $urunrenkgrupad=$urunrenkgrup_t["urunrenkgrupad"];
                                            ?>
                                            <tr id="tr<?=$urunrenkgrupid?>">
                                                <td><?=$urunrenkgrupid?></td>
                                                <td><?=$urunrenkgrupad?></td>
                                                <td>
                                                    <a
                                                            href="/_y/s/s/varyasyonlar/renkgrupekle.php?urunrenkgrupid=<?=$urunrenkgrupid?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="simpleModalLabel">Renk Grup Sil</h4>
            </div>
            <div class="modal-body">
                <p>Grubu silmek istediğinize emin misiniz?</p>
            </div>
...
<script>
    ...
    {
        $('a#Renkgrupsil').click(function ()
        {
            $silid=$(this).data("id");
        });
        $('#silbutton').click(function ()
        {
            $('#_islem').attr('src', "/_y/s/f/sil.php?sil=Renkgrup&id="+$silid);
        });
    });
</script>
<script>
    $("#renkgruplistephp").addClass("active");
</script>
</body>
</html>
