...
<html lang="en">
	...
	<body class="menubar-hoverable header-fixed ">
					...
					<div class="offcanvas-body">
						<div class="card">				
							<div class="card-body no-padding">
								<form action="/_y/s/f/faviconyukle.php" target="_islem" class="dropzone dz-clickable" id="myawesomedropzone">
									<div class="form-group">
										<input type="hidden" name="resimklasor" value="sayfa">
										<div class="dz-message">
											<h3>Resmi Sürükleyin ve Bırakın veya Tıklayın.</h3>
											<em>En fazla <strong>1 (1MB)</strong> resim seçin</em>
										</div>
									</div>
								</form>
							</div><!--end .card-body -->
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">İCON RESİM EKLE</li>
						</ol>
					</div>
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h1 class="text-primary">Resimi soldaki panele bırakın</h1>
							</div><!--end .col -->
							<div class="col-lg-8">
		...
		<!-- END JAVASCRIPT -->
		<script>
			$("#faviconeklephp").addClass("active");
		</script>
		<script type="text/javascript">
			...
			Dropzone.options.myawesomedropzone =
			{
				...
				maxFiles: 1,
				maxFilesize: 1,
				dictDefaultMessage: "Resimi yüklemek için bırakın",
