...
//düzenle
$sayfabaslik="Kişi Listesi";
$formbaslik="Kişi Liste";

Veri(true);
$rehber_d=0;
$rehber_s="
	SELECT 
		rehberid,rehberadsoyad,rehbergsm,rehbereposta,rehberaktif,rehbergrupad 
	FROM 
		rehber 
			left join rehbergrup ON 
				rehbergrup.rehbergrupid=rehber.rehbergrupid 
	WHERE 
		rehbersil='0' ORDER BY rehber.rehbergrupid,rehberadsoyad ASC";
if($data->query($rehber_s)){$rehber_d=1;$rehber_v=$data->query($rehber_s);unset($rehber_s);}else{hatalogisle("rehber getir",$data->error);}
?>
<!DOCTYPE html>
<html lang="tr">
	<head>
	...
	<body class="menubar-hoverable header-fixed ">
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">Kişiler</li>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-head style-primary">
										...
										<div class="tools">
											<a class="btn btn-floating-action btn-default-light" href="/_y/s/s/gonderiler/kisiekle.php"><i class="fa fa-plus"></i></a>
										</div>
									</div>
								</div><!--end .card -->
							</div><!--end .col -->
									...
									<div class="card-body ">
										<table class="table no-margin">
											...
											if($rehber_d==1)
											{
												...
												{
													$rehberid=$rehber_t["rehberid"];
													$rehberad=$rehber_t["rehberadsoyad"];
													$rehbergrupad=$rehber_t["rehbergrupad"];
													$rehbereposta=$rehber_t["rehbereposta"];
													$rehbergsm=$rehber_t["rehbergsm"];
													$rehberonay=$rehber_t["rehberaktif"];
													if(S($rehberonay)==0)$rehberonay="Hayır";else$rehberonay="Evet";
												?>
												<tr id="tr<?=$rehberid?>">
													<td><?=$rehberid?></td>
													<td><?=$rehberad?></td>
													...
													<td>
														<a 
															href="/_y/s/s/gonderiler/kisiekle.php?rehberid=<?=$rehberid?>" 
											...
											unset($rehber_d,$rehber_v,$rehberid,$rehberkisaad);
											?>
											</tbody>
										</table>
									</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="simpleModalLabel">Kişi Sil</h4>
					</div>
		...
		<script>
			...
			$(document).ready(function()
			{
				...
				{
					$('#_islem').attr('src', "/_y/s/f/sil.php?sil=rehber&id="+$silid);
				});
			 });
		</script>
		<script>
			$("#rehberlistephp").addClass("active");
		</script>
	</body>
</html>
