...
//düzenle
$sayfabaslik="İade Talebi Listesi";
$formbaslik="İade Talebi Listesi";

Veri(true);
$iptaliadedegisim_d=0;
$iptaliadedegisim_s="SELECT talepid,uyeid,siparisid,degisimtur,iadenedeni,iadeaciklama,urunid,tarih FROM iptaliadedegisim WHERE talepsil='0' and degisimtur='İade' ORDER BY talepid ASC";
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">İade Talebi Listesi</li>
						</ol>
					</div>			
