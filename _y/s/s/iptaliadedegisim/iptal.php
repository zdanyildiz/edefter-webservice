...
//düzenle
$sayfabaslik="İptal Talebi Listesi";
$formbaslik="İptal Talebi Listesi";

Veri(true);
$iptaliadedegisim_d=0;
$iptaliadedegisim_s="SELECT talepid,uyeid,siparisid,degisimtur,iadenedeni,iadeaciklama,urunid,tarih FROM iptaliadedegisim WHERE talepsil='0' and degisimtur='İptal' ORDER BY talepid ASC";
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<li class="btn ink-reaction btn-raised btn-primary disabled">İptal Talebi Listesi</li>
						</ol>
					</div>			
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="simpleModalLabel">İptal Talebini Sil</h4>
					</div>
					<div class="modal-body">
						<p>İptal talebini silmek istediğinize emin misiniz?</p>
					</div>
