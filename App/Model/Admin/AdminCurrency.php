...
class AdminCurrency
{
    ...
    public function getCurrencyIDByCode($currencyCode)
    {
        $sql = "
            ...
            FROM 
                urunparabirim
            WHERE 
                parabirimkod = :currencyCode
        ";
        return $this->db->select($sql, ['currencyCode' => $currencyCode]);
    ...
    {
        // Para birimi ekleme işlemi yapılırken üst yapı değerleri eklenir
        //transaction işlemlerini controller'da yapacağız
        $sql = "
            INSERT INTO 
                urunparabirim 
            SET 
                parabirimad = :currencyName,
                parabirimsimge = :currencySymbol,
                parabirimkod = :currencyCode,
                parabirimkur = :currencyRate,
                parabirimkurtarih = NOW(),
                parabirimsil = 0
        ";
    ...
    {
        // Para birimi güncelleme işlemi yapılırken üst yapı değerleri eklenir
        //transaction işlemlerini controller'da yapacağız
        $sql = "
            UPDATE 
                urunparabirim 
    ...
    public function deleteCurrency($currencyID)
    {
        ...
        return $this->db->update($sql, ['currencyID' => $currencyID]);
